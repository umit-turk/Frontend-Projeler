...
const Blog2 = () => {
  return (
    <div className="blog-container">
      <h2 className="blog-head">WWF launches new Forces of Nature</h2>
      <p className="blog-paragraph">
        We have launched a new podcast series, Forces of Nature hosted by our
        media relations manager, Susannah Birkwood. In each episode, we
        introduce candid conversations between prominent environmentalists from
        different generations across four continents about what they’ve learned,
        and their regrets, during the past decades – and how we can all achieve
        more for the planet in the next 10 years than we did in the last six
        decades.
      </p>
      <img
        className="blog-img"
        src="https://updates.panda.org/hs-fs/hubfs/Esmeralda%202-2.jpg?width=2880&name=Esmeralda%202-2.jpg"
      />
      <p className="blog-paragraph">
